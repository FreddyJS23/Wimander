    ...
    <div className={styles['container-login']}>
      <div className={styles['login-izquierdo']}>
        <div className={styles['encabezado-izquierdo']}>
          <p>Bienvenido a</p>
          <img src={Logo} alt="logo" className={`${styles['icono']}, ${styles['icono-logo']}`} />
        </div>
        <div className={styles['contenidoPrincipal']}>
            <img className={styles['imagen']}  src={imagePrincipal} alt="icono imagen" />
      ...
      <div className={styles['login-derecho']}>
        <div className={styles['encabezado-derecho']}>
            {!registrar ? <p>Iniciar seccion</p> : <p> <img className={styles['flechaIzquierda']} onClick={handleClick} src= {flechaIzquierda} alt="regresar" /> Registrarse</p>  }
       
        </div>

<div className={styles['container-form']}>

{loading ? <LoaderSpinner /> : !registrar ? <FormSesion handleClick={handleClick} /> :  <FormRegistroUsuario /> }
